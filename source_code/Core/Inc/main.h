...
#define ICM42688_SPI_CS_Pin LL_GPIO_PIN_2
#define ICM42688_SPI_CS_GPIO_Port GPIOC
#define ICM42688_INT_Pin LL_GPIO_PIN_3
#define ICM42688_INT_GPIO_Port GPIOC
#define ICM42688_INT_EXTI_IRQn EXTI3_IRQn
